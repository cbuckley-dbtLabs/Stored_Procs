with raw_customers as (
    select
        ...
        phone,
        country_raw
    from analytics.dbt_cbuckley.stg_raw_customers
    where customer_no is not null
      and customer_no not in (select customer_no from analytics.dbt_cbuckley.stg_customers)
...
raw_mapped as (
    select
        ...
        'ACTIVE' as status
    from raw_customers
    left join analytics.dbt_cbuckley.stg_ref_countries as country
...
select * from analytics.dbt_cbuckley.stg_customers
