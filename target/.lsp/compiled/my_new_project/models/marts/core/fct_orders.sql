with order_ids as (
    select
        ...
        promo_code,
        source_system
    from analytics.dbt_cbuckley.int_valid_order_refs
),
...
line_totals as (
    ...
    from analytics.dbt_cbuckley.fct_order_lines
    group by order_id
),

default_warehouse as (
    select warehouse.warehouse_id
    from analytics.dbt_cbuckley.stg_warehouses as warehouse
...
left join analytics.dbt_cbuckley.int_order_promotions as promo
