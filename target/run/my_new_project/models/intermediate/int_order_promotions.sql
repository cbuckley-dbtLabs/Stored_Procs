  ...
  create or replace   view analytics.dbt_cbuckley_stored_proc.int_order_promotions
...
promo_lines as (
    ...
    left join analytics.dbt_cbuckley_stored_proc.stg_promotions as promo
        on promo.promo_code = order_subtotals.promo_code
    left join analytics.dbt_cbuckley_stored_proc.int_order_line_inputs as lines
