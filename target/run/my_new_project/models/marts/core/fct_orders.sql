...
create or replace transient  table analytics.dbt_cbuckley_stored_proc.fct_orders
    
    
    
    
    as (with order_ids as (
    select
        ...
        promo_code,
        source_system
    from analytics.dbt_cbuckley_stored_proc.int_valid_order_refs
),
...
default_warehouse as (
    ...
    from analytics.dbt_cbuckley_stored_proc.stg_warehouses as warehouse
...
left join analytics.dbt_cbuckley_stored_proc.int_order_promotions as promo
