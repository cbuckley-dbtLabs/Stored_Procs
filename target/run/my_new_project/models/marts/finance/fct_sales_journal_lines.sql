...
create or replace transient  table analytics.dbt_cbuckley_stored_proc.fct_sales_journal_lines
    ...
    inner join analytics.dbt_cbuckley_stored_proc.int_order_usd_rates as rates
...
from journal_lines
left join analytics.dbt_cbuckley_stored_proc.stg_gl_accounts as account
