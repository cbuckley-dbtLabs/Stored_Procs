...
create or replace transient  table analytics.dbt_cbuckley_stored_proc.rpt_low_stock_report
...
from analytics.dbt_cbuckley_stored_proc.rpt_inventory_snapshot as snapshot
inner join analytics.dbt_cbuckley_stored_proc.int_product_master as product
    on product.product_id = snapshot.product_id
left join analytics.dbt_cbuckley_stored_proc.int_suppliers as supplier
    on supplier.supplier_id = product.supplier_id
left join analytics.dbt_cbuckley_stored_proc.stg_stock_levels as stock
